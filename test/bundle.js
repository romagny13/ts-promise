...
/***/ function(module, exports, __webpack_require__) {
	...
	var promise_base_1 = __webpack_require__(44);
	var promise_array_1 = __webpack_require__(45);
	var TSPromise = (function (_super) {
	    __extends(TSPromise, _super);
	    function TSPromise(fn, id) {
	        var _this = _super.call(this) || this;
	        if (!id) {
	            _this._id = util_1.idGen.getNewId();
	        }
	        else {
	            _this._id = util_1.idGen.getId(id);
	        }
	    ...
	    TSPromise.prototype.then = function (onComplete, onReject) {
	        this._child = promise_base_1.createChildPromise(this, this._id);
	        this._onComplete = onComplete;
	        this._onReject = onReject;
	        if (this._state === promise_base_1.PromiseState.waitCompleteCallBack) {
	            this._doComplete(this._pending);
	        }
	        else if (this._state === promise_base_1.PromiseState.waitRejectionCallBack) {
	            if (util_1.isFunction(this._onReject)) {
	                this._doRejection(this._pending);
	            }
	        }
	        else {
	            this._state = promise_base_1.PromiseState.waitResolveOrReject;
	        }
	        return this._child;
	    };
	    TSPromise.prototype.catch = function (onReject) {
	        // parent is root ?
	        if (this._parent._state === promise_base_1.PromiseState.completed) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createChildPromise(parent, id) {
	    var child = new promise_1.TSPromise(null, id);
	    child._parent = parent;
	    return child;
	}
	exports.createChildPromise = createChildPromise;
	...
	exports.TSPromiseBase = TSPromiseBase;
	...
	var TSPromiseArray = (function (_super) {
	    ...
	    TSPromiseArray.prototype._race = function (promises) {
	        ...
	        promises.forEach(function (promise) {
	            promise.then(function (result) {
	                if (_this._state !== promise_base_1.PromiseState.completed) {
	                    if (result) {
	                        _this._promiseResults.push(result);
	                    }
	                    _this.resolve(result);
	    ...
	    TSPromiseArray.prototype.then = function (onComplete, onReject, onNotify) {
	        ...
	        // pending notify ?
	        if (util_1.isFunction(this._onNotify)) {
